...
### [1주차] 2026-03-02 ~ 2026-03-08 (완료)
*(지난 주차 기록은 여기에 보관하거나 아래로 옮겨주세요)*

### [2주차] 2026-03-09 ~ 2026-03-15
| 날짜 | 담당자 | 유형 | 문제명 | 출처 | 링크 | 상태 |
| :--- | :--- | :---: | :--- | :--- | :--- | :---: |
| **03/09 (월)** | **전원** | **리뷰** | **A형 기출 코드리뷰** | - | - | - |
| 03/10 (화) | 이강륜 | 기초 | (문제명) | BAEKJOON | [Link]() | ⬜ |
| 03/11 (수) | 오민근 | 기초 | (문제명) | SWEA | [Link]() | ⬜ |
| 03/12 (목) | 황민정 | 기초 | (문제명) | BAEKJOON | [Link]() | ⬜ |
| 03/13 (금) | 안윤주 | **기초+A** | (기초) / (A형 기출) | BAEKJOON | [Link]() | ⬜ |
| 03/14 (토) | 오민근 | 기초 | (문제명) | SWEA | [Link]() | ⬜ |
| 03/15 (일) | 안윤주 | 기초 | (문제명) | BAEKJOON | [Link]() | ⬜ |
