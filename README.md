요청하신 대로 폴더명 규칙에 **알고리즘 유형**이 포함되도록 리드미를 수정했습니다. 문제 담당자가 폴더를 만들 때 어떤 유형인지 한눈에 알 수 있어 나중에 복습할 때 훨씬 유용할 거예요!
...
이제 이 리드미를 레포지토리에 올리면 스터디 준비 끝입니다! 혹시 첫 번째 문제 업로드 브랜치 만드는 것부터 저와 함께 연습해볼까요? 도움이 필요하면 언제든 말씀해 주세요! 😊